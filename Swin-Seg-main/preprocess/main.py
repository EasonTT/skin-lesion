...
def print_hi():
    ...
    gt_dir = 'C:/Users/Chadm/chainer-skin-lesion-detector/data/ISIC2018_Task1_Validation_GroundTruth/'
    name_list = os.listdir(img_dir)
    for i, name in enumerate(name_list):
        os.rename(img_dir + name, img_dir + str(i) + '.jpg')
        os.rename(gt_dir + name[:-4] + '_segmentation' + '.png', gt_dir + str(i) + '.png')
...
if __name__ == "__main__":
    ...
    #xml_dir = "C:/Users/tanyi/chainer-skin-lesion-detector/data/val_xml/"
    #json_file = "C:/Users/tanyi/chainer-skin-lesion-detector/data/instances_train.json"  # output json
    ...
    val_xml_dir = "C:/Users/tanyi/chainer-skin-lesion-detector/data/val_xml/"
    val_json_file = "C:/Users/tanyi/chainer-skin-lesion-detector/data/instances_val.json"  # output json
